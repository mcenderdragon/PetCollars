...
public class PendantList 
{
	...
	public static final PendantBase<?> heat_resistance_pendant = new FireResistancePendant(30, 0xFF6600, 50).setRegistryName(PetCollarsMain.MODID, "heat_resistance_pendant");
